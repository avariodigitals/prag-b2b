      ...
      <div className="w-full px-4 sm:px-6 md:px-20 py-10 sm:py-12 md:py-16 bg-sky-950 border-b border-stone-50 flex flex-col justify-center items-center gap-6 overflow-hidden">
        <div className="w-full max-w-[1280px] mx-auto flex flex-col items-center gap-8 text-center">
          <div className="w-full flex flex-col items-center gap-4 text-center">
            <h2 className="w-full text-center text-white text-[34px] sm:text-[46px] md:text-[58px] lg:text-7xl font-bold font-['Onest'] leading-[1.05]">
              <span className="block">Stop Losing Money</span>
              <span className="block">to Bad Power</span>
            </h2>
            <p className="w-full max-w-[740px] text-center text-white/70 text-base sm:text-lg md:text-xl font-normal font-['Onest'] leading-[1.45]">
            {ctaDescription}
            </p>
          </div>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <Link
              href={primaryCtaHref}
              className="w-full sm:w-auto h-14 px-8 bg-gradient-to-r from-[#1B7FC0] to-[#0166A5] rounded-full flex justify-center items-center gap-2.5 hover:brightness-110 transition-all whitespace-nowrap"
            >
              <span className="text-white text-base font-medium [font-family:var(--font-space-grotesk)] leading-[1.2]">
                {primaryCtaLabel}
              </span>
            </Link>
            <a
              ...
              className="group w-full sm:w-auto h-14 px-8 rounded-full border border-white text-white flex justify-center items-center gap-2.5 hover:bg-white hover:text-sky-950 transition-colors whitespace-nowrap"
            >
