          ...
          <div className="flex-1 min-w-0 flex flex-col gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className={`flex-1 h-14 px-6 rounded-[24px] flex items-center justify-center gap-2.5 transition-colors font-['Space_Grotesk'] text-[16px] font-medium ${
                  isOutOfStock
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 h-14 px-6 rounded-[24px] border border-[#0166a5] flex items-center justify-center gap-2.5 text-[#0166a5] hover:bg-[#0166a5]/5 transition-colors font-['Space_Grotesk'] text-[16px] font-medium"
              >
