    ...
    <div className="w-full px-4 md:px-20 pt-8 md:pt-12 pb-12 md:pb-16">
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-5 md:gap-6 max-w-[620px]">
          <div className="flex flex-col gap-3 md:gap-4">
            ...
            {product.short_description && (
              <div className="text-zinc-500 text-sm md:text-base leading-relaxed font-['Space_Grotesk']"
      ...
      <div className="w-full p-4 md:p-8 bg-white rounded-2xl outline outline-1 outline-gray-200 flex flex-col gap-6">
        ...
        <div>
          {activeTab === 'Description' && (
            <div className="prose prose-sm max-w-none text-zinc-700 text-sm md:text-base leading-relaxed font-['Space_Grotesk']"
                  ...
                  return (
                    <div key={review.id} className="flex flex-col gap-2.5 pb-7 border-b border-gray-100 last:border-0">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-zinc-500 text-base md:text-lg leading-none font-normal font-['Onest']">
      ...
      {related.length > 0 && (
        <div className="flex flex-col gap-6">
          <h2 className="text-zinc-900 text-xl md:text-2xl font-bold font-['Onest']">Related Products</h2>
