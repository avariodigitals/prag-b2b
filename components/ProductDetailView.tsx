          ...
          <div className="flex-1 min-w-0 flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-3 sm:hidden">
              ...
              <a
                ...
                className="w-full h-[66px] px-6 rounded-[24px] bg-[#25D366] hover:bg-[#1ebe5d] flex items-center justify-center gap-3 text-white transition-colors font-['Space_Grotesk'] text-[18px] font-medium leading-none whitespace-nowrap"
              >
            ...
            <div className="hidden sm:flex sm:flex-row gap-4">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => trackLead({ content_name: product.name, content_category: 'Product — WhatsApp Order' })}
                className="flex-1 h-14 px-6 rounded-[24px] bg-[#25D366] hover:bg-[#1ebe5d] flex items-center justify-center gap-3 text-white transition-colors font-['Space_Grotesk'] text-[16px] font-medium leading-none whitespace-nowrap"
              >
