          ...
          <div className="flex-1 min-w-0 flex flex-col gap-8">
            ...
            <div className="flex items-center gap-[10px] md:gap-5">
              ...
              <div className="flex items-center gap-3 md:gap-5">
                ...
                >
                  <svg className="w-6 h-6 md:w-7 md:h-7" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                <a
                  ...
                  className="text-[#444444] hover:text-[#0166a5] transition-colors"
                >
                  <svg className="w-6 h-6 md:w-7 md:h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
