...
const inputCls = "w-full h-12 px-3 bg-white rounded-lg border border-zinc-300 text-zinc-900 text-base font-['Onest'] focus:border-sky-700 outline-none transition-colors";
...
export default function DistributorForm() {
  ...
  if (status === 'sent') {
    return (
      <div className="w-full max-w-3xl p-10 bg-white rounded-xl border border-zinc-300 flex flex-col items-center gap-4 text-center">
