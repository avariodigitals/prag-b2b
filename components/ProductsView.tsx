      ...
      <div className="flex items-center gap-3 flex-wrap">
        {TOP_CATEGORIES.map(cat => (
          <button
            ...
            className={`px-5 py-2.5 rounded-full text-sm font-medium font-['Space_Grotesk'] border transition-colors ${
              activeTop === cat.slug
      ...
      {subcategories.length > 0 && (
        <div className="flex items-center gap-6 border-b border-zinc-200 overflow-x-auto pb-0">
          <button
            ...
            className={`pb-3 text-sm font-medium font-['Space_Grotesk'] whitespace-nowrap border-b-2 transition-colors ${
              !activeSub
