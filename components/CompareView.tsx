  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-6 md:px-10 py-12 flex flex-col gap-10">
      ...
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <p className="text-zinc-500 text-lg md:text-xl font-['Montserrat'] max-w-md">
              ...
              <thead>
                <tr className="bg-sky-800 text-white">
                  ...
                  {selected.map((p, idx) => (
                    ...
                    >
                      <p className="font-bold font-['Montserrat'] text-lg md:text-xl">{p!.name}</p>
                      <p className="text-sky-200 text-lg md:text-xl font-['Montserrat'] font-normal mt-0.5">
                        {p!.categories[0]?.name ?? ''}
                      </p>
                    </th>
                  ))}
            ...
            <div className="grid grid-cols-2 gap-2">
              {selected.map((p) => (
                <div key={p!.id} className="rounded-xl border border-zinc-200 bg-white p-3">
                  ...
                  <p className="text-zinc-500 text-lg md:text-xl font-['Montserrat'] mt-1">{p!.categories[0]?.name ?? ''}</p>
                </div>
              ))}
            </div>
