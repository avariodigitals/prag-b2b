              ...
              <div className="w-full lg:flex-1 flex flex-col justify-start items-start gap-5 lg:gap-6">
                ...
                <div className="self-stretch grid grid-cols-1 gap-4">
                  <div className="rounded-2xl p-4">
                    <p className="text-[#0166A5] text-base uppercase tracking-[0.08em] font-semibold font-['Space_Grotesk']">The Problem</p>
                    <p className="mt-2 text-neutral-700 text-[17px] sm:text-lg font-normal font-['Onest'] leading-relaxed"><SentenceText text={study.problem} /></p>
                  </div>

                  <div className="rounded-2xl p-4">
                    <p className="text-[#0166A5] text-base uppercase tracking-[0.08em] font-semibold font-['Space_Grotesk']">The Solution</p>
                    <p className="mt-2 text-neutral-700 text-[17px] sm:text-lg font-normal font-['Onest'] leading-relaxed"><SentenceText text={study.solution} /></p>
                  </div>
