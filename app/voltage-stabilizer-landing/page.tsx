    ...
    <main className="w-full min-h-screen bg-white text-[#1a1a1a]">
      ...
      <div className="w-full bg-white border-b border-zinc-100">
        <div className="w-full px-8 sm:px-12 lg:px-16 h-auto md:h-20 py-3 md:py-0 flex items-center justify-between gap-4 flex-wrap md:flex-nowrap">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border-2 border-[#38bdf8] bg-white px-3 sm:px-4 py-2 sm:py-2.5 text-sm font-semibold text-[#0a4f7c] font-['Arial, Helvetica, sans-serif'] hover:bg-[#38bdf8] hover:text-white transition-colors shrink-0"
          >
            <Phone className="w-4 h-4" />
            <span className="sm:hidden">Call</span>
            <span className="hidden sm:inline">Call {SALES_PHONE}</span>
          </a>
        </div>
      </div>
        ...
        <div className="relative w-full px-8 sm:px-12 lg:px-16 py-5 md:py-10 lg:py-14">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="order-2 lg:order-1 flex flex-col gap-6">
              ...
              <h1 className="text-white text-[42px] leading-[46px] md:text-[74px] md:leading-[78px]" style={{ fontFamily: 'Arial, Helvetica, sans-serif', fontWeight: 400, fontStyle: 'normal' }}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                ...
                <TrackedWhatsAppLink
                  href={chatHref}
                  leadName="Voltage Stabilizer Landing — Chat with Expert"
      ...
      <section className="w-full bg-white py-14 md:py-20">
        <div className="w-full px-8 sm:px-12 lg:px-16">
          ...
          <h2 className="text-left text-[#1a1a1a] mb-4 text-[32px] leading-[36px] md:text-[54px] md:leading-[58px]" style={{ fontFamily: 'Arial, Helvetica, sans-serif', fontWeight: 400, fontStyle: 'normal' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {[
              ...
              <div key={b.title} className="flex flex-col items-center gap-6 rounded-2xl border border-zinc-300 bg-white p-6 shadow-sm">
                <div className="w-full flex items-center justify-center h-28 sm:h-40 rounded-2xl bg-[#38bdf8]/5">
                  <div className="h-14 w-14 sm:h-20 sm:w-20 rounded-full bg-[#38bdf8]/10 text-[#0a4f7c] flex items-center justify-center">
                    <b.icon className="w-8 h-8 sm:w-10 sm:h-10" />
                  </div>
                </div>
                <div className="w-full text-left flex flex-col justify-center">
                  <h3 className="text-[#1a1a1a] mb-2 text-[20px] leading-[28px] md:text-[24px] md:leading-[36px]" style={{ fontFamily: 'Arial, Helvetica, sans-serif', fontWeight: 400, fontStyle: 'normal' }}>{b.title}</h3>
      ...
      <section className="relative w-full overflow-hidden bg-[#071a2f] py-14 md:py-20">
        ...
        <div className="relative w-full px-8 sm:px-12 lg:px-16">
          ...
          <h2 className="text-white mb-4 text-[32px] leading-[36px] md:text-[54px] md:leading-[58px]" style={{ fontFamily: 'Arial, Helvetica, sans-serif', fontWeight: 400, fontStyle: 'normal' }}>Stable, protected power at<br />every scale.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div key={a.title} className="relative overflow-hidden rounded-2xl bg-white/10 backdrop-blur-md p-6 md:p-8 text-white flex flex-col min-h-[260px] border border-white/20">
                ...
                <span className="text-3xl sm:text-4xl font-bold text-[#7BB7FF] font-['Arial, Helvetica, sans-serif'] mb-4">{String(i + 1).padStart(2, '0')}</span>
                <h3 className="mb-3 text-[20px] leading-[28px] md:text-[24px] md:leading-[36px]" style={{ fontFamily: 'Arial, Helvetica, sans-serif', fontWeight: 400, fontStyle: 'normal' }}>{a.title}</h3>
        ...
        <div className="w-full px-8 sm:px-12 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            <div className="lg:pr-12">
              ...
              <h2 className="text-[#1a1a1a] mb-4 text-[32px] leading-[36px] md:text-[54px] md:leading-[58px]" style={{ fontFamily: 'Arial, Helvetica, sans-serif', fontWeight: 400, fontStyle: 'normal' }}>
            ...
            <div className="rounded-2xl border border-zinc-200 bg-white p-6 md:p-8 shadow-sm">
              ...
              <h3 className="text-[#1a1a1a] mb-6 text-[20px] leading-[28px] md:text-[24px] md:leading-[36px]" style={{ fontFamily: 'Arial, Helvetica, sans-serif', fontWeight: 700, fontStyle: 'normal' }}>Get your recommendation</h3>
