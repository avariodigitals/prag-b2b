  ...
  return (
    <main className="w-full bg-white flex flex-col flex-1 min-h-[70vh] justify-center items-center px-6 py-20 text-center gap-8">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4">
        <Link
          href="/"
          className="px-8 py-3.5 bg-sky-700 hover:bg-sky-800 text-white text-base font-semibold font-['Space_Grotesk'] rounded-full transition-colors"
        >
          Go to Homepage
        </Link>
        <Link
          href="/contact"
          className="px-8 py-3.5 border border-sky-700 text-sky-700 hover:bg-sky-50 text-base font-semibold font-['Space_Grotesk'] rounded-full transition-colors"
        >
          Contact Support
        </Link>
      </div>
