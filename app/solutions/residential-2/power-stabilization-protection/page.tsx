...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.prag.global/solutions/residential-2/power-stabilization-protection' },
};
    ...
    <main className="w-full bg-white flex flex-col">
      ...
      <div className="w-full px-6 md:px-20 py-10">
        <div className="max-w-[1280px] mx-auto">
          <SolutionProductTabs
            basePath="/solutions/residential-2/power-stabilization-protection"
            tabs={tabs}
            activeTab={sp.tab}
