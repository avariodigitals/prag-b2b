...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const override = getAdminSeoOverride(content?.seoOverrides, '/solutions/solar-energy');
  const seo = resolveStaticSeo('/solutions/solar-energy', override);
...
export default async function SolarEnergyPage() {
  ...
  const fallbackCards = [
    { title: 'Lower Energy Costs', description: 'Reduce electricity and generator fuel costs with solar energy solutions designed for long-term savings.', href: '/products/solar', ctaLabel: 'View Products', image: 'https://central.prag.global/wp-content/uploads/2026/05/Rectangle-6.png' },
    { title: 'Reduced Generator Dependence', description: 'Reduce reliance on generators with cleaner, quieter, and more sustainable power generation.', href: '/products/solar', ctaLabel: 'View Products', image: 'https://central.prag.global/wp-content/uploads/2026/05/Rectangle-6.png' },
    { title: 'Energy Independence', description: 'Generate your own electricity and reduce dependence on unreliable utility power.', href: '/products/solar', ctaLabel: 'View Products', image: 'https://central.prag.global/wp-content/uploads/2026/05/Rectangle-6.png' },
  ];
  ...
  return (
    <main className="w-full flex flex-col">
      <JsonLd data={buildBreadcrumbJsonLd([
        ...
        { name: 'Solar Energy', url: `${SITE_BASE}/solutions/solar-energy` },
      ])} />
