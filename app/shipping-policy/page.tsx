            ...
            <div className="flex flex-col gap-4">
              {DELIVERY_TIMEFRAMES.map((item) => (
                <div key={item.area} className="pl-4 border-l-4 border-sky-700 flex flex-col gap-1">
                  <p className="text-zinc-900 text-sm font-semibold font-['Space_Grotesk']">{item.area}</p>
                  <p className="text-zinc-500 text-sm font-['Space_Grotesk']">{item.time}</p>
                </div>
              ))}
            </div>
          ),
          ...
          body: (
            <div className="flex flex-col gap-4">
              ...
              <div className="p-4 bg-sky-50 rounded-xl border border-sky-100">
                <p className="text-sky-700 text-sm font-medium font-['Space_Grotesk']">Free Shipping on orders above ₦500,000 within Lagos</p>
              </div>
            </div>
          ),
        },
        ...
        },
        {
          ...
          body: (
            <div className="flex flex-col gap-5">
              <div>
                <p className="text-zinc-900 text-sm font-semibold font-['Space_Grotesk'] mb-2">Delivery</p>
              ...
              <div>
                <p className="text-zinc-900 text-sm font-semibold font-['Space_Grotesk'] mb-2">Installation</p>
                <ul className="list-disc pl-5 flex flex-col gap-1.5">
