...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const tags = Array.isArray(body?.tags)
      ? body.tags
      : ['b2b-public-content', 'b2b-site-settings', 'b2b-categories', 'b2b-hidden-categories', 'b2b-products-list', 'b2b-product-by-slug', 'b2b-product-reviews', 'b2b-tech-documents', 'b2b-stores', 'b2b-product-custom-tabs', 'b2b-all-product-slugs'];
